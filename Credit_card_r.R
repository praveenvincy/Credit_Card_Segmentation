...
############ Loading Packages##########
#Load Libraries
x = c("ggplot", "corrgram",'DMwR','labeling')
...
setwd("C:/Users/WIN 10/Desktop/ccs-project-1")
getwd()
...
#Check Missing value after Mean Imputation
...
# Concatenating labels found through Kmeans with dataset as column 'Cluster'
